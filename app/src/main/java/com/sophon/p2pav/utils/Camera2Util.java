...
public class Camera2Util implements TextureView.SurfaceTextureListener {
    ...
    public Camera2Util(Context context, TextureView textureView, int width, int height, OnPreviewListener onPreviewListener) {
        mContext = context;
        mImageWidth = width;
        mImageHeight = height;
...
//      mPreviewBuilder.set(CaptureRequest.CONTROL_AE_MODE,CaptureRequest.CONTROL_AE_MODE_ON_AUTO_FLASH);
    ...
    private ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            buffer.get(data);
            mOnPreviewListener.onGeData(data);
            img.close();
        }
    };
